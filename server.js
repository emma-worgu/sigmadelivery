...
const corsOption = {
  origin: ['https://khamaniexpress.site', 'https://elteslaworld.site', 'https://sigmadelivery-frontend.pages.dev', 'https://sladatransport.com', 'https://topdovelogistics.online', 'https://globateesla.site/'],
};
